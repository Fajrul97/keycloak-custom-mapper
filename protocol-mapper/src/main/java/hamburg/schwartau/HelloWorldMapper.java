...
public class HelloWorldMapper extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper, OIDCIDTokenMapper, UserInfoTokenMapper {
    ...
    public String getDisplayType() {
        return "Unique ID Mapper";
    }

    @Override
    public String getHelpText() {
        return "Adds a unique ID to the claim";
    }
    ...
    protected void setClaim(final IDToken token,
        ...
        String test = keycloakSession.getContext().getRequestHeaders().getHeaderString("unique");
        try {
            System.out.println(test);
            if ( test == null) {
                System.out.println("Header Unique is null.");
            ...
            Map<String, String> error = ImmutableMap.of("message", "Header Unique is not present.");
